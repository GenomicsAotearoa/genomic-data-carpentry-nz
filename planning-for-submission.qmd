...
1. A spectrophotometer (e.g., NanoDrop, DeNovix), which will give you a good indication of the purity/contamination of your sample through 260/280 and 260/230 ratios. This method is not very reliable for determining concentration of your nucleic acid.
...
There are several sequencing facilities which offer NGS services around New Zealand that you can use.
...
- platforms: Illumina and ONT. Not listed on their website which ones they have.
...
**AgResearch**  
 - GenomNZ https://www.agresearch.co.nz/products-and-services/genomnz/ (Invermay) have a NovaSeq. They are a commercial animal DNA genotyping laboratory. I believe they will on occasion sequence research samples if there is time/space on the machine - need to check with them.  
 

**Lincoln**  
-  have MGI - compatible with Illumina libraries. not on website, but i think this is potentially open to other research samples. 


**Other**   

**Custom science** (supplier, does not do the sequencing for you)  
- New [PacBio Revio in Auckland](https://www.customscience.co.nz/kindstar-new-zealand )
