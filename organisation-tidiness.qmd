...
- Have column names be explanatory, but without spaces. Use ‘-’, ‘_’ or camel case instead of a space. For instance ‘library-prep-method’ or ‘LibraryPrep’ are better than ’library preparation method’ (because computers interpret spaces in particular ways) and are also better than ‘prep’ (more informative).  
