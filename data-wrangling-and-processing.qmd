...
Here we will not show you how to use the CLI; we recommend checking out our workshops on [Introduction to Shell](https://genomicsaotearoa.github.io/BioinformaticsTrainingProgramme/portfolio.html#introduction-to-shell-for-bioinformatics) and 
...
[SAM file](https://en.wikipedia.org/wiki/SAM_(file_format)), opened in a text editor. Note all lines in the header section starts with an '@' symbol, and the number of lines in the header section is variable. There are 11 mandatory fields in the alignment section (not all visible here as they run off the window to the right). 
...
Two of our genomic analysis workshops ([RNA-Seq Data Analysis](https://genomicsaotearoa.github.io/BioinformaticsTrainingProgramme/portfolio.html#rna-seq-data-analysis) and [Microbial genome assembly](https://genomicsaotearoa.github.io/BioinformaticsTrainingProgramme/portfolio.html#microbial-genome-assembly-with-short-reads)) teach you how to run fastqc on your files. Here, we will give you an introduction to what it is and how to interpret the results. 
...
# EXERCISE #1 🧠🏋️‍♀️ (4 mins) - Human Genome Assembly
...
# EXERCISE #2 🧠🏋️‍♀️ (4 mins) - Sea Anemone Genome Assembly
